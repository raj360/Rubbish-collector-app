...
const LocalProfilePicture = require("../assets/profilePic.jpg")
const Logo = require("../assets/iconSmaller.png");
const LogoOnboarding = require("../assets/images/argon-logo-onboarding.png");
const ProfileBackground = require("../assets/images/yellowBg.png");
const RegisterBackground = require("../assets/images/register-bg.png");
const Pro = require("../assets/images/getPro-bg.png");
const CaptureImage = require('../assets/captureImage.png');
const ArgonLogo = require("../assets/icon.png");
